...
NOTE: I could not make a video because there are some error hanlings which were not being handled correctly, so I have keot the code fully so please consider this sir.